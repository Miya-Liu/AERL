# Qwen3.5 Model Arguments for Customized Archon Engine
# Copied from areal/experimental/models/archon/qwen3_5/model/args.py
...
@dataclass
class Qwen35ModelArgs(BaseModelArgs):
    ...
    def from_hf_config(
        ...
        **kwargs,
        ...
        """Create Qwen35ModelArgs from HuggingFace config."""
        ...
        return cls(
            ...
            max_seq_len=getattr(hf_config, "max_position_embeddings", 262144),
