# Qwen3.5 State Dict Adapter for Customized Archon Engine
# Copied from areal/experimental/models/archon/qwen3_5/model/state_dict_adapter.py
...
class Qwen35StateDictAdapter(BaseStateDictAdapter):
        ...
        for key, value in archon_state_dict.items():
            ...
            if "moe.experts.w" in key:
                if isinstance(value, DTensor):
                    hf_pairs = self._split_moe_experts_dtensor(key, value)
                else:
