...
class MathAgentWithTokenRewards:
    ...
    def _compute_token_rewards(
        ...
        for i, token in enumerate(tokens):
            ...
            if token_normalized in answer_normalized or answer_normalized in token_normalized:
                reward += 0.5
...
def main(args):
    ...
    from areal.api.cli_args import load_expr_config, PPOConfig
    ...
    with PPOTrainer(
        ...
        trainer.train(
            workflow=MathAgentWithTokenRewards()
        )
...
def demo_token_rewards():
    ...
    """
    from customized_areal.token_reward.interaction_types import InteractionWithTokenLevelReward
