...
**Rule:** Do NOT modify files in the `areal/` directory. All custom implementations (datasets, workflows, rewards, etc.) must be placed in `customized_areal/`.

**Why:** This maintains clean separation between core framework code (areal/) and user customizations (customized_areal/), making upgrades and maintenance easier.
