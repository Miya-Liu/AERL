---
name: Do Not Validate
description: User does not want config validation or verification steps run after edits
type: feedback
---

**Rule:** Do not run validation or verification steps after making config file edits.
